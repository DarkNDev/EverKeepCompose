...
val SeaGreenLight = Color(0xFF82b99a)
val SeaGreenLightAlt = Color(0xFFabd1bc)
val Pink80 = Color(0xFFEFB8C8)

val SeaGreen = Color(0xFF2e8b57)
val SeaGreenAlt = Color(0xFF58a279)
val Pink40 = Color(0xFF7D5260)

val DarkColorScheme = darkColorScheme(
    primary = SeaGreenLight,
    secondary = SeaGreenLightAlt,
    tertiary = Pink80,
